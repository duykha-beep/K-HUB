...
spawn(function() 
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>TRAN DUY KHA FORMEN<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(("https://raw.githubusercontent.com/duykha-beep/K-HUB/refs/heads/main/v15.lua")))()
local Window = OrionLib:MakeWindow({Name = "khaduytran.sofware", HidePremium = false, IntroText = "TranDuyKha", SaveConfig = true, ConfigFolder = "K-HUB"})



OrionLib:MakeNotification({
    Name = "copyright@khaduytran",
...
OrionLib:MakeNotification({
    Name = "Thông Báo",
    Content = "Chúc Các Bạn Sử Dụng Script Acc Giàu,Dragon Đầy kho",
    Image = "rbxassetid://8192162908",
    Time = 10
})
...
W:AddLabel("PHÁT TRIỂN BỞI:K-HUB")
W:AddLabel("KDT-HUB")
W:AddLabel("Phở Bờ:TranDuyKha")
local Section = W:AddSection({
    Name = "Status"
})
